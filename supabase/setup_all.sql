...
drop policy if exists "Admins delete profiles"          on public.shared_profiles;
...
create policy "Admins delete profiles"     on public.shared_profiles for delete using (public.is_admin(auth.uid()));
